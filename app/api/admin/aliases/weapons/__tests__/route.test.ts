...
describe('DELETE /api/admin/aliases/weapons/[id]', () => {
  const mockSupabase = {
    from: vi.fn(),
  }
  ...
  it('should delete a weapon alias', async () => {
    const aliasesQuery = {
    ...
    const request = new NextRequest('http://localhost:3000/api/admin/aliases/weapons/1', {
      method: 'DELETE',
    })
